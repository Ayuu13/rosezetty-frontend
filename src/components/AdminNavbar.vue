<template>
    <div class="main">
        ...
        <router-link to="/admin" class="logo"><h4>Rosezzty</h4></router-link>
    
        <div class="nav-bar" :class="{ 'responsive': isResponsive }">
            <router-link to="/admin/produk" class="nav-link">Produk</router-link>
            <router-link to="/admin/pesanan" class="nav-link">Pesanan</router-link>
            <router-link to="/admin/pemasukan" class="nav-link">Pemasukan</router-link>
            <router-link to="/admin/pelanggan" class="nav-link">Pelanggan</router-link>
            
            <div class="dropdown">
            <div v-show="isDropdownOpen" class="dropdown-content">
                <router-link @click="closeDropdown" to="/admin/produk">Produk</router-link>
                <router-link @click="closeDropdown" to="/admin/pesanan">Pesanan</router-link>
                <router-link @click="closeDropdown" to="/admin/pemasukan" class="nav-link">Pemasukan</router-link>
                <router-link @click="closeDropdown" to="/admin/pelanggan">Pelanggan</router-link>
            </div>
            </div>
        </div>
