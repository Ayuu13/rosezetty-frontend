        ...
        <table class="table align-items-center mb-0">
          ...
          <tbody>
            <tr v-for="(product, index) in productsByType" :key="index">
              ...
              <td>
                <h4 class="text-center mb-0">{{ product.totalPesanan !== undefined ? product.totalPesanan : 0 }}</h4>
              </td>
              <td>
              ...
              <td>
                <router-link :to="'/admin/produk-detail/' + product.id" class="product-det">
                  Detail
                </router-link>
              </td>
            </tr>
      ...
      try {
        ...
        await Promise.all(this.products.map(async (product) => {
          try {
            ...
            product.totalPesanan = 0; // Set default value in case of error
          }
        }));
